                        ...
                        <form role="form" method="POST" action="{{route('groups.store')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="users">Groups</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea class="form-control @error('announcement') is-invalid @enderror" name="announcement" id="announcement" rows="4" autocomplete="off">{{ old('announcement') }}</textarea>
                                        <span class="text-danger">@error('announcement') {{ $message }} @enderror</span>
                                    </div>
                                </div>
