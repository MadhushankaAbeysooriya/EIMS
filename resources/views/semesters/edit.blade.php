            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-cyan">
                        ...
                        <form role="form" action="{{ route('semesters.update',$semester->id) }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 col-form-label">Semester Name</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control @error('name')
                                        is-invalid @enderror" name="name" value="{{ $semester->name }}" id="name" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        is-invalid @enderror" name="abbr" value="{{ $semester->abbr }}" id="abbr" autocomplete="off">
